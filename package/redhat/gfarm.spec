...
/usr/doc/%{name}-%{version}/html/en/ref/man3/gfs_chmod.3.html
/usr/doc/%{name}-%{version}/html/en/ref/man3/gfs_chown.3.html
/usr/doc/%{name}-%{version}/html/en/ref/man3/gfs_closedir.3.html
/usr/doc/%{name}-%{version}/html/en/ref/man3/gfs_mkdir.3.html
...
/usr/doc/%{name}-%{version}/html/en/ref/man3/gfs_rename.3.html
/usr/doc/%{name}-%{version}/html/en/ref/man3/gfs_rmdir.3.html
...
/usr/doc/%{name}-%{version}/html/ja/ref/man1/gfrmdir.1.html
...
/usr/doc/%{name}-%{version}/html/ja/ref/man3/gfs_chmod.3.html
/usr/doc/%{name}-%{version}/html/ja/ref/man3/gfs_chown.3.html
/usr/doc/%{name}-%{version}/html/ja/ref/man3/gfs_closedir.3.html
/usr/doc/%{name}-%{version}/html/ja/ref/man3/gfs_mkdir.3.html
...
/usr/doc/%{name}-%{version}/html/ja/ref/man3/gfs_rename.3.html
/usr/doc/%{name}-%{version}/html/ja/ref/man3/gfs_rmdir.3.html
