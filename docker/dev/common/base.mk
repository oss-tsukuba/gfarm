...
DOCKER_BUILD_FLAGS = \
		...
		--build-arg GFDOCKER_SASL_MECH_LIST='$(GFDOCKER_SASL_MECH_LIST)' \
		--build-arg GFDOCKER_SASL_LOG_LEVEL='$(GFDOCKER_SASL_LOG_LEVEL)' \
		--build-arg GFDOCKER_SASL_XOAUTH2_SCOPE='$(GFDOCKER_SASL_XOAUTH2_SCOPE)' \
		--build-arg GFDOCKER_SASL_XOAUTH2_AUD='$(GFDOCKER_SASL_XOAUTH2_AUD)' \
		--build-arg GFDOCKER_SASL_XOAUTH2_USER_CLAIM='$(GFDOCKER_SASL_XOAUTH2_USER_CLAIM)'
