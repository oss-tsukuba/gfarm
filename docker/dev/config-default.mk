...
#	"user1" and "+tenant2" depend on the setting of
#	GFDOCKER_USERNAME_PREFIX, GFDOCKER_NUM_USERS and GFDOCKER_TENANTNAME_PREFIX
...
GFDOCKER_SASL_XOAUTH2_GROUP_USER=user1|${GFDOCKER_SASL_XOAUTH2_SCOPE}|${GFDOCKER_SASL_XOAUTH2_ISSUER} user1+tenant2|${GFDOCKER_SASL_XOAUTH2_SCOPE}|${GFDOCKER_SASL_XOAUTH2_ISSUER}
