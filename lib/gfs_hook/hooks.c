...
error:
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __read: %s", e));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _read"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking read"));
	return (__read(filedes, buf, nbyte));
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _libc_read"));
	return (__read(filedes, buf, nbyte));
}
...
__close(int filedes)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __close: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
_close(int filedes)
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _close"));
...
close(int filedes)
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking close"));
	return (__close(filedes));
}
...
__unlink(const char *path)
{
	...
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED,
	    "Hooking __unlink(%s)", path));

	if (!gfs_hook_is_url(path, &url))
		return syscall(SYS_unlink, path);

	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED,
	    "GFS: Hooking __unlink(%s)", path));
 ...
 free_url:
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __unlink: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _unlink"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking unlink"));
	return (__unlink(path));
}
...
__access(const char *path, int type)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __access: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _access"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking access"));
	return (__access(path, type));
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _mmap"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking mmap"));
	return (__mmap(addr, len, prot, flags, fildes, off));
}
#endif
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _dup2"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking dup2"));
	return (__dup2(oldfd, newfd));
}
#endif /* SYS_dup2 */
...
__dup(int oldfd)
{
	...
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED,
	    "Hooking __dup(%d)", oldfd));

	if ((gf = gfs_hook_is_open(oldfd)) == NULL)
		return syscall(SYS_dup, oldfd);

	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED,
	    "GFS: Hooking __dup(%d)", oldfd));
...
_dup(int oldfd)
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _dup"));
	return (__dup(oldfd));
}
...
dup(int oldfd)
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking dup"));
	return (__dup(oldfd));
}
...
__execve(const char *filename, char *const argv [], char *const envp[])
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED,
	    "GFS: Hooking __execve(%s)", url));
	e = gfs_execve(url, argv, envp);
	free(url);
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __execve: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _execve"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking execve"));
	return (__execve(filename, argv, envp));
}
...
__utimes(const char *path, const struct timeval *tvp)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __utimes: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _utimes"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking utimes"));
	return (__utimes(path, tvp));
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _lutimes"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking lutimes"));
	return (__lutimes(path, tvp));
}
#endif /* SYS_lutimes */
...
__utime(const char *path, const struct utimbuf *buf)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __utime: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _utime"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking utime"));
	return (__utime(path, buf));
}
#endif /* SYS_utime */
...
__mkdir(const char *path, mode_t mode)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __mkdir: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _mkdir"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking mkdir"));
	return (__mkdir(path, mode));
}
...
__rmdir(const char *path)
{
	...
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED,
	    "Hooking __rmdir(%s)", path));

	if (!gfs_hook_is_url(path, &url))
		return syscall(SYS_rmdir, path);

	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED,
	    "GFS: Hooking __rmdir(%s)", path));
	e = gfs_rmdir(url);
	free(url);
	if (e == NULL) {
		errno = errno_save;
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __rmdir: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _rmdir"));
	return (__rmdir(path));
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking rmdir"));
	return (__rmdir(path));
}
...
__chdir(const char *path)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __chdir: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _chdir"));
	return (__chdir(path));
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking chdir"));
	return (__chdir(path));
}
...
__fchdir(int filedes)
{
	...
	_gfs_hook_debug(
		gflog_info(GFARM_MSG_UNFIXED,
		    "GFS: Hooking __fchdir(%d)", filedes));
...
error:
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __fchdir: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
_fchdir(int filedes)
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _fchdir"));
...
fchdir(int filedes)
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking fchdir"));
	return (__fchdir(filedes));
}
...
error:
	if (alloced)
		free(buf);
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __getcwd: %s", e));
	errno = gfarm_error_to_errno(e);
	return (NULL);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _getcwd"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking getcwd"));
	return (__getcwd(buf, size));
}
...
__chmod(const char *path, mode_t mode)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __chmod: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _chmod"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking chmod"));
	return (__chmod(path, mode));
}
...
__lchmod(const char *path, mode_t mode)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __lchmod: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _lchmod"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking lchmod"));
	return (__lchmod(path, mode));
}
...
__fchmod(int filedes, mode_t mode)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __fchmod: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _fchmod"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking fchmod"));
	return (__fchmod(filedes, mode));
}
...
__chown(const char *path, uid_t owner, gid_t group)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __chown: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _chown"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking chown"));
	return (__chown(path, owner, group));
}
...
__lchown(const char *path, uid_t owner, gid_t group)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __lchown: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _lchown"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking lchown"));
	return (__lchown(path, owner, group));
}
...
__fchown(int fd, uid_t owner, gid_t group)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __fchown: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _fchown"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking fchown"));
	return (__fchown(fd, owner, group));
}
...
__acl(const char *path, int cmd, int nentries, aclent_t *aclbuf)
{
	...
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED,
	    "Hooking __acl(%s, 0x%x)", path, cmd));

	if (!gfs_hook_is_url(path, &url))
		return (syscall(SYS_acl, path, cmd, nentries, aclbuf));

	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED,
	    "GFS: Hooking __acl(%s, 0x%x)", path, cmd));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _acl"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking acl"));
	return (__acl(path, cmd, nentries, aclbuf));
}
...
__rename(const char *oldpath, const char *newpath)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __rename: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _rename"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking rename"));
	return (__rename(oldpath, newpath));
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _symlink"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking symlink"));
	return (__symlink(oldpath, newpath));
}
...
__link(const char *oldpath, const char *newpath)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __link: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _link"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking link"));
	return (__link(oldpath, newpath));
}
...
getxattr(const char *path, const char *name, void *value, size_t size)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: getxattr: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
	...
	int flags)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: setxattr: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
__mknod(const char *path, mode_t mode, dev_t dev)
{
	...
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking __mknod"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _mknod"));
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking mknod"));
	return (__mknod(path, mode, dev));
}
...
#endif
{
	...
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking __xmknod"));
...
#endif
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _xmknod"));
...
__fcntl(int filedes, int cmd, ...)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __fcntl: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
__fsync(int filedes)
{
	...
	_gfs_hook_debug(gflog_info(GFARM_MSG_UNFIXED, "GFS: __fsync: %s", e));
	errno = gfarm_error_to_errno(e);
	return (-1);
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking _getdent: %d",
				  filedes));
	return (FUNC___GETDENTS(filedes, (STRUCT_DIRENT *)buf, nbyte, NULL));
}
...
{
	_gfs_hook_debug_v(gflog_info(GFARM_MSG_UNFIXED, "Hooking getdent: %d",
				  filedes));
	return (FUNC___GETDENTS(filedes, (STRUCT_DIRENT *)buf, nbyte, NULL));
}
