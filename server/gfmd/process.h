...
internal_ino_t process_get_cwd(struct process *);
gfarm_error_t process_set_cwd(struct process *, internal_ino_t);
...
gfarm_error_t process_open_file(struct process *, internal_ino_t,
