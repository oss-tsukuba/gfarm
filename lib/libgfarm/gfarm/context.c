...
#	define BUFSIZE_MAX 2048
	...
	ctxp->network_receive_bandwidth_drop_ratio = GFARM_CONFIG_MISC_DEFAULT;
	ctxp->network_receive_bandwidth_measurement_duration =
	    GFARM_CONFIG_MISC_DEFAULT;
	ctxp->network_send_bandwidth_drop_ratio = GFARM_CONFIG_MISC_DEFAULT;
	ctxp->network_send_bandwidth_measurement_duration =
	    GFARM_CONFIG_MISC_DEFAULT;
