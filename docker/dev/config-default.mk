...
#
# GFDOCKER_SASL_XOAUTH2_SCOPE:
# 	to change these values, change scripts in ./common/oauth2/ as well
#
# GFDOCKER_SASL_XOAUTH2_ISSUER / ISSUERS:
#	issuer URL(s) for XOAUTH2 validation
#	- Multiple issuers can be defined as ISSUER, ISSUER2, ... and
#	  combined into ISSUERS
#
# GFDOCKER_SASL_XOAUTH2_GROUP_USER:
#	"user1" and "user5" depend on the setting of
#	GFDOCKER_USERNAME_PREFIX and GFDOCKER_NUM_USERS
...
GFDOCKER_SASL_XOAUTH2_ISSUER=https://jwt-keycloak:8443/auth/realms/hpci
GFDOCKER_SASL_XOAUTH2_ISSUERS=${GFDOCKER_SASL_XOAUTH2_ISSUER}
GFDOCKER_SASL_XOAUTH2_GROUP_USER=user1|${GFDOCKER_SASL_XOAUTH2_SCOPE}|${GFDOCKER_SASL_XOAUTH2_ISSUER} user5|${GFDOCKER_SASL_XOAUTH2_SCOPE}|${GFDOCKER_SASL_XOAUTH2_ISSUER}
