...
gfarm_error_t watcher_fd_readable_event_alloc(int,
	struct thread_pool *, void *(*)(void *), void *,
	struct watcher_event **);
gfarm_error_t watcher_fd_writable_event_alloc(int,
	struct thread_pool *, void *(*)(void *), void *,
	struct watcher_event **);
gfarm_error_t watcher_fd_closing_event_alloc(int,
	void *(*)(void *), void *,
	struct watcher_event **);
void watcher_fd_closing_event_add_relevant_event(
	struct watcher_event *, struct watcher_event *);
int watcher_event_is_invoking(struct watcher_event *);
...
int watcher_add_event(struct watcher *, struct watcher_event *);
#if 0
