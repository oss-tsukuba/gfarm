...
enum gfm_proto_command {
	...
	GFM_PROTO_XATTR_INODE_SET,
	GFM_PROTO_XMLATTR_INODE_SET,
	GFM_PROTO_XATTR_INODE_GET,
	GFM_PROTO_XMLATTR_INODE_GET,
	GFM_PROTO_XATTR_INODE_REMOVE,
	GFM_PROTO_XMLATTR_INODE_REMOVE,
