...
gfarm_error_t gfp_xdr_new_fd(int, struct gfp_xdr **);
gfarm_error_t gfp_xdr_set_fd(struct gfp_xdr *, int);
...
int gfarm_iobuffer_nonblocking_read_fd_op(struct gfarm_iobuffer *,
	void *, int, void *, int);
int gfarm_iobuffer_nonblocking_write_fd_op(struct gfarm_iobuffer *,
	void *, int, void *, int);
int gfarm_iobuffer_blocking_read_fd_op(struct gfarm_iobuffer *,
	void *, int, void *, int);
int gfarm_iobuffer_blocking_write_fd_op(struct gfarm_iobuffer *,
	void *, int, void *, int);
