...
s3update:
	$(s3setup)
s3update: CONTSHELL_FLAGS += --env UPDATE_ONLY=1
s3update: CONTSHELL_FLAGS += --env GFDOCKER_GFARMS3_USERS='$(GFDOCKER_GFARMS3_USERS_DEFAULT)'
s3update: CONTSHELL_FLAGS += --env GFDOCKER_GFARMS3_MYPROXY_SERVER='$(GFDOCKER_GFARMS3_MYPROXY_SERVER_DEFAULT)'
s3update: CONTSHELL_FLAGS += --env GFDOCKER_GFARMS3_SHARED_DIR='$(GFDOCKER_GFARMS3_SHARED_DIR_DEFAULT)'
