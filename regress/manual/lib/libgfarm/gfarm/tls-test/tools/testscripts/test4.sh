...
run_test "4-1" \
    ...
    "${TOP_DIR}/tls-test --allow_no_crl --tls_ca_certificate_path ${ENV_DIR}/A/cacerts_all" ${debug_flag}
...
run_test "4-2" \
    ...
    --tls_key_file ${ENV_DIR}/A/server/server.key \
    --tls_ca_certificate_path ${ENV_DIR}/A/cacerts_all --once" \
    "${TOP_DIR}/tls-test --allow_no_crl --tls_ca_certificate_path ${ENV_DIR}/B/cacerts_all" ${debug_flag}
...
run_test "4-4" \
    ...
    "${TOP_DIR}/tls-test --allow_no_crl --tls_ca_certificate_path ${ENV_DIR}/A/cacerts_root" ${debug_flag}
