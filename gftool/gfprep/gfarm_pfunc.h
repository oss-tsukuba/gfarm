...
gfarm_error_t gfarm_pfunc_replicate(gfarm_pfunc_t *, const char *,
				    const char *, int,
				    const char *, int, void *, int);
gfarm_error_t gfarm_pfunc_remove_replica(gfarm_pfunc_t *, const char *,
					 const char *, int, void *);
gfarm_error_t gfarm_pfunc_copy(gfarm_pfunc_t *,
