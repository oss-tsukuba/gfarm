...
GFDOCKER_PRIMARY_UID = 1000
GFDOCKER_TENANT_ADMIN_USER = $(GFDOCKER_USERNAME_PREFIX)$$((1 + $(GFDOCKER_NUM_USERS)))
GFDOCKER_TENANT_ADMIN_UID = $$((1000 + $(GFDOCKER_NUM_USERS)))
GFDOCKER_TENANTNAME_PREFIX = tenant
...
DOCKER_BUILD_FLAGS = \
		...
		--build-arg GFDOCKER_TENANTNAME_PREFIX='$(GFDOCKER_TENANTNAME_PREFIX)' \
		--build-arg GFDOCKER_PRIMARY_USER='$(GFDOCKER_PRIMARY_USER)' \
		--build-arg GFDOCKER_PRIMARY_UID="$(GFDOCKER_PRIMARY_UID)" \
		--build-arg GFDOCKER_TENANT_ADMIN_USER="$(GFDOCKER_TENANT_ADMIN_USER)" \
		--build-arg GFDOCKER_TENANT_ADMIN_UID="$(GFDOCKER_TENANT_ADMIN_UID)" \
		...
		--build-arg GFDOCKER_NUM_TENANTS='$(GFDOCKER_NUM_TENANTS)' \
...
GFDOCKER_GFARM_TEST_CKSUM_MISMATCH=/tmp/cksum_mismatch
...
CONTSHELL_FLAGS = \
		...
		--env GFDOCKER_TENANTNAME_PREFIX='$(GFDOCKER_TENANTNAME_PREFIX)' \
		--env GFDOCKER_PRIMARY_USER='$(GFDOCKER_PRIMARY_USER)' \
		--env GFDOCKER_TENANT_ADMIN_USER="$(GFDOCKER_TENANT_ADMIN_USER)" \
		...
		--env GFDOCKER_NUM_TENANTS='$(GFDOCKER_NUM_TENANTS)' \
		...
		--env GFDOCKER_SASL_XOAUTH2_GROUP_USER='$(GFDOCKER_SASL_XOAUTH2_GROUP_USER)' \
		--env GFDOCKER_GFARM_TEST_CKSUM_MISMATCH='$(GFDOCKER_GFARM_TEST_CKSUM_MISMATCH)'
...
TOP='$(TOP)' \
	...
	GFDOCKER_PRIMARY_UID="$(GFDOCKER_PRIMARY_UID)" \
	GFDOCKER_TENANT_ADMIN_USER="$(GFDOCKER_TENANT_ADMIN_USER)" \
	GFDOCKER_TENANT_ADMIN_UID="$(GFDOCKER_TENANT_ADMIN_UID)" \
	...
	GFDOCKER_USE_CHROME_CONTAINER='$(GFDOCKER_USE_CHROME_CONTAINER)' \
